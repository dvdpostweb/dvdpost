class WishlistItem < ActiveRecord::Base
  ...
  named_scope :current, :conditions => ['products.products_next = ? and products.products_availability != ?', '0', '-1, 0']
  named_scope :future, :conditions => ['products.products_next = ? and products.products_availability != ?', '1', '-1, 0']
  named_scope :not_available, :conditions => ['products.products_availability = ?',  '-1, 0']
