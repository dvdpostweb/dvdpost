  ...
  def update
    case current_customer.svod_adult
      when 0
        ...
        svod = CustomersSvod.find_or_create_by_customer_id(:customer_id => current_customer.id, :validity_period => 'M', :amount => 19.95, :product_abo_id => 130129)
        svod.update_attribute(:validityto, 1.month.from_now)
